                ...
                <div id="primary" class="site-content">
                    <article id="post-3" class="post-3 page type-page status-publish hentry">
                        ...
                        <p>
                            ...
                            📧 <strong>{{ __('privacy.section1.email') }}</strong> <a>contact@portaboxsolutions.com</a><br>
                        ...
                        <ul class="wp-block-list">
                            ...
                            <li><strong>{{ __('privacy.section2.contact') }}</strong> {{ __('privacy.section2.contact_text') }}</li>
                        ...
                        <p>
                            ...
                            📧 <strong><a>contact@portaboxsolutions.com</a></strong>
                        </p>
